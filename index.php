        ...
        <nav class="bg-white relative rounded-xl ">
            ...
            <div id="mobile-menu"
                ...
                <div class="px-2 pt-2 pb-3 flex flex-col items-center space-y-1">
                    <a href="#"
                        class="block text-gray-900 bg-gray-100 px-3 py-2 rounded-md text-base font-medium opacity-0 translate-x-4 transition-all duration-300 menu-item"
                        style="transition-delay: 0ms;">Dashboard</a>
                    <a href="#"
                        class="block text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium opacity-0 translate-x-4 transition-all duration-300 menu-item"
                        style="transition-delay: 50ms;">Transaction</a>
                    <a href="#"
                        class="block text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium opacity-0 translate-x-4 transition-all duration-300 menu-item"
                        style="transition-delay: 100ms;">Payments</a>
                    <a href="#"
                        class="block text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium opacity-0 translate-x-4 transition-all duration-300 menu-item"
                        style="transition-delay: 150ms;">Exchange</a>
                    <a href="#"
                        class="block text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium opacity-0 translate-x-4 transition-all duration-300 menu-item"
                        style="transition-delay: 200ms;">Support</a>
                </div>
            </div>
        </nav>
    </header>
                ...
                <div class="bg-white rounded-xl col-span-1 row-span-1 shadow-lg p-6 card-hover animate-slide-in">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p id="totalIncome" class="text-3xl font-bold text-green-600">0 MAD</p>
                        </div>
                        <div
                ...
                <div class="bg-white rounded-xl col-span-1 row-span-1 shadow-lg p-6 card-hover animate-slide-in"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p id="totalExpense" class="text-3xl font-bold text-red-600">0 MAD</p>
                        </div>
                        <div
                ...
                <div class="bg-white w-[100%] col-span-2 row-span-1 rounded-xl shadow-lg p-6 card-hover animate-slide-in"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p id="balance" class="text-3xl font-bold text-blue-600">0 MAD</p>
                        </div>
                        <div
                            class="w-14 h-14 bg-gradient-to-br from-blue-100 to-indigo-200 rounded-full flex items-center justify-center">
